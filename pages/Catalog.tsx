    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <aside className="hidden md:block w-64 space-y-8 flex-shrink-0">
          ...
          <div className="bg-white dark:bg-black p-6 rounded-2xl text-center border border-slate-100 dark:border-white/10 shadow-soft dark:shadow-luxury">
            <h4 className="font-serif font-bold text-pink-500 mb-2">Cupão Primeira Compra</h4>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 font-medium">Use o código BEMVINDA10 para 10% OFF</p>
            <div className="text-pink-500 font-mono font-bold border-2 border-dashed border-pink-200 dark:border-pink-500/30 p-2 rounded bg-pink-50 dark:bg-pink-500/5">BEMVINDA10</div>
          </div>
        </aside>
        ...
        <div className="flex-grow">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
            ...
            <div className="flex items-center space-x-4 w-full sm:w-auto">
              ...
              <button className="md:hidden flex-1 flex items-center justify-center bg-white dark:bg-black/50 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-2 text-sm dark:text-slate-100 shadow-soft dark:shadow-luxury transition-all">
              ...
              <div className="relative flex-1 sm:flex-none">
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-black border border-slate-200 dark:border-white/10 rounded-lg px-4 py-2 text-sm outline-none appearance-none pr-8 cursor-pointer text-slate-900 dark:text-slate-200"
                >
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-20 bg-white dark:bg-black border border-slate-100 dark:border-white/10 rounded-[2.5rem] shadow-soft dark:shadow-luxury">
              <SlidersHorizontal size={48} className="mx-auto text-slate-300 dark:text-white/10 mb-4" />
              <h3 className="text-xl font-serif font-bold mb-2 text-slate-900 dark:text-white">Sem resultados</h3>
              <p className="text-slate-500 dark:text-slate-400">Tente ajustar os filtros ou a categoria.</p>
              <button
                onClick={() => {
